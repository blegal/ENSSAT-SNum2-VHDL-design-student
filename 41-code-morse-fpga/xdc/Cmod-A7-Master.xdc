...
#set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_CS]
#set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_MOSI]
#set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_SCK]
#set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_DC]
#set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_RES]
#set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_VCCEN]
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_EN]
